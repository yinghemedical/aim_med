...
import { ISelectFormProps } from 'types/pages/MedicalImagesExplore/components/SelectForm/SelectForm';
...
function SelectForm({
  ...
  function handleSearch(e?: React.ChangeEvent<any>): void {
    ...
    searchMetricsRef.current = medicalImagesExploreAppModel.getImagesData(
      true,
      true,
      query ?? '',
    );
  ...
  function handleRequestAbort(e: React.SyntheticEvent): void {
    ...
    searchMetricsRef.current?.abort();
    medicalImagesExploreAppModel.abortRequest();
  }
