...
import { IGroupingSelectOption } from 'types/services/models/medicalImagesExplore/medicalImagesExploreAppModel';
...
function getMedicalImagesTableColumns(
  paramColumns: string[] = [],
...
function MedicalImagesExploreTableRowRenderer(
  rowData: any,
  onRunsTagsChange: (runHash: string, tags: ITagInfo[]) => void,
...
export { getMedicalImagesTableColumns, MedicalImagesExploreTableRowRenderer };
