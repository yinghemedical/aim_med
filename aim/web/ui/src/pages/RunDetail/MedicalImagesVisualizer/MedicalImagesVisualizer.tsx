...
import './MedicalImagesVisualizer.scss';

function MedicalImagesVisualizer(
  ...
  console.log('MedicalImagesVisualizer');
...
MedicalImagesVisualizer.displayName = 'MedicalImagesVisualizer';

export default memo<IImagesVisualizerProps>(MedicalImagesVisualizer);
