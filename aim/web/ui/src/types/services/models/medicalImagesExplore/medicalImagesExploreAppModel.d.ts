...
export interface IMedicalImagesExploreAppConfig {
  grouping: {
    row: string[];
    reverseMode: {
      row: boolean;
...
export interface IMedicalImagesExploreAppModelState {
  refs: {
...
export interface IMedicalImageData {
  blob_uri: string;
  caption: string;
  context: object;
  format: string;
...
export interface IProcessedMedicalImageData extends IImageData {
  seqKey?: string;
  name?: string;
  step?: number;
  context?: object;
...
export interface IMedicalImageRunData {
  hash: string;
